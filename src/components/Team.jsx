...
const BrokiTeamPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className='w-309 h-250 '>
        <div className='items-center justify-center'>
          <h2 className="font-poppins text-[2.0rem] text-xl font-semibold leading-tight tracking-normal text-gray-900 text-center py-18">Meet Our Founders</h2>    
          <div className='grid grid-cols-2 gap-10 max-w-5xl mx-auto pl-25 p-6'>
            <div className='flex flex-col items-center bg-white pl-8 p-6 w-[330px] rounded-lg shadow-md'>
              <img src="https://www.broki.in/images/team/jatin_image.jpeg" alt="Founder 1" className="w-60 h-60 rounded-full border border-gray-400 mb-4"/>
              <h1 className="text-2xl font-semibold">Jatin Anand</h1>
              <p className="text-gray-600 text-[14px] mt-3">Founder - CEO</p>
              <p className="text-gray-600 text-sm text-center leading-loose mt-4">Jatin, our Founder, is a seasoned entrepreneur with over 5 years in hospitality and 3 years in finance. He owns multiple restaurants and food brands like The Flashback, Burgelicious, and The Shawarma King. Jatin aims to share his extensive food market expertise with Broki's users.</p>
            </div>
            <div className='flex flex-col items-center bg-white ml-9 pl-8 p-6 w-[330px] rounded-lg shadow-md'>
              <img src="https://www.broki.in/images/team/akash_image.jpeg" alt="Founder 1" className="w-60 h-60 rounded-full border border-gray-400 mb-4"/>
              <h1 className="text-2xl font-semibold">Akash Malhotra</h1>
              <p className="text-gray-600 text-[14px] mt-3">Founder - CEO</p>
              <p className="text-gray-600 text-sm text-center leading-loose mt-4">Akash, with 11 years of industry experience, leads all technical implementations at Broki. An MBA graduate from IIM Lucknow, he excels in bridging technical and business needs. Known for his strategic vision and innovative solutions, Akash is a pivotal figure in driving technological advancements.</p>
            </div>
          </div>
        </div>          
      </div>
